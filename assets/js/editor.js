        ...
        require(['vs/editor/editor.main'], function () {
            ...
            monaco.editor.defineTheme('dev-codelist', {
                ...
                rules: [
                    ...
                    { token: 'operator.keyword', foreground: 'f472b6' },
            ...
            monaco.languages.setMonarchTokensProvider('bdfd', {
                ...
                tokenizer: {
                    root: [
                        ...
                        [/\$[a-zA-Z_]\w*/, 'tag'],
                        [/\{(if|elseif|while|for|switch|case)\b[^}]*\}/, 'keyword'],
                        [/\{(endif|else|endwhile|endfor|endswitch|break|continue|return|function|endfunction|try|catch|endtry|loop)\b[^}]*\}/, 'keyword'],
